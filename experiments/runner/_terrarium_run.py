# =============================================================================
# VENDORED, UNMODIFIED, from Terrarium's `examples/base_main.py`.
# Source: https://github.com/umass-aisec/Terrarium  (examples/base_main.py)
# Terrarium is MIT-licensed (Nakamura et al., arXiv:2510.14312). The code below
# is copied verbatim; only this header was added. We vendor it because
# `examples/` ships with the Terrarium source tree but is NOT part of the
# installed `terrarium-agents` wheel, and this study installs Terrarium as a
# dependency rather than containing its source. Only `run_simulation` is used.
#
# MIT License — Copyright (c) UMass AI Security Lab (Terrarium authors).
# =============================================================================
"""
